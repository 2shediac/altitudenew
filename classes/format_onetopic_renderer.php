...
class theme_altitude_format_onetopic_renderer extends format_onetopic_renderer {
     ...
     */
    protected function get_altitude_onetopic_weeks() {
        $useonetopicweeks = get_config('theme_altitude', 'onetopicweeks') ?
            get_config('theme_altitude', 'onetopicweeks') : false;
    ...
    public function get_default_section_name($course, $section) {
        $onetopicweeks = $this->get_altitude_onetopic_weeks();
        if (!!$onetopicweeks) {
    ...
    public function print_single_section_page($course, $sections, $mods, $modnames, $modnamesused, $displaysection) {
        ...
        $onetopicweeks = $this->get_altitude_onetopic_weeks(); // AMT-136

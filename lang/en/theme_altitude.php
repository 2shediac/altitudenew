...
$string['mycoursessort'] = 'My Courses Menu Sorting';
$string['mycoursessortdesc'] = 'Sorting options for My Courses Menu. Visible courses are displayed before hidden courses.';
$string['sortfullnameasc'] = 'Visibility, Fullname Ascending';
$string['sortstartdatedesc'] = 'Visibility, Start Date Descending';
$string['sortidasc'] = 'Visibility, Course ID Ascending';

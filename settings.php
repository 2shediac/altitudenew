...
if ($ADMIN->fulltree) {
    ...
    if ($tab === THEME_ALTITUDE_TAB_DESIGN) {
        ...
        // Image Pause setting.
        $name = 'theme_altitude/pausesetting';
        ...
        $name = 'theme_altitude/onetopicweeks';
        $title = get_string('onetopicweeks', 'theme_altitude');
        $description = get_string('onetopicweeksdesc', 'theme_altitude');
        ...
        // My courses menu sort order
        $name = 'theme_altitude/mycoursessort';
        $title = get_string('mycoursessort', 'theme_altitude');
        $description = get_string('mycoursessortdesc', 'theme_altitude');
        $setting = new admin_setting_configselect($name, $title, $description, 'fullnameasc', array(
            'fullnameasc' => get_string('sortfullnameasc', 'theme_altitude'),
            'startdatedesc' => get_string('sortstartdatedesc', 'theme_altitude'),
            'idnumberasc' => get_string('sortidasc', 'theme_altitude')
        ));
        $setting->set_updatedcallback('theme_reset_all_caches');
        $settings->add($setting);
